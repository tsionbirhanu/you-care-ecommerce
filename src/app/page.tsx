...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#EFECE4]">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a
                href="#"
                className="hover:text-[#AB8872] transition-colors focus:outline-none focus:ring-2 focus:ring-[#AB8872] rounded px-2 py-1">
                Home
              </a>
              <a
                href="#"
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              <Button
                variant="ghost"
                size="sm"
                className="text-white hover:text-[#AB8872] hover:bg-transparent focus:outline-none focus:ring-2 focus:ring-[#AB8872] hidden sm:inline-flex">
                Login
              </Button>
              <Button
                size="sm"
      ...
      <main>
        <section className="relative py-12 sm:py-16 lg:py-24 overflow-hidden bg-[#EFECE4]">
          <div className="container mx-auto px-6">
            <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-16">
              {/* TEXT CONTENT */}
              <div className="text-center lg:text-left space-y-4 lg:space-y-6 max-w-lg mx-auto lg:mx-0">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#62664B] leading-snug">
                  Glow from Within
                </h1>
                <p className="text-base sm:text-lg lg:text-xl text-[#62664B]/80">
                  Trusted healthcare and beauty products for your holistic
                  lifestyle.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                  <Button
                    size="lg"
                    className="bg-[#62664B] hover:bg-[#AB8872] text-white rounded-full px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#62664B] focus:ring-offset-2">
                    Shop Now
                  </Button>
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-[#62664B] text-[#62664B] hover:bg-[#62664B] hover:text-white rounded-full px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#62664B] focus:ring-offset-2">
                    Learn More
                  </Button>
                </div>
              </div>
              ...
              <div className="relative w-full lg:w-1/2">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-tr from-[#62664B]/20 to-transparent rounded-2xl z-10"></div>
                  <Image
                    src="/image/glow2.jpeg"
                    alt="Beautiful woman with glowing skin holding natural beauty products"
                    width={600}
                    height={600}
                    className="rounded-2xl shadow-2xl group-hover:scale-105 transition-transform duration-500 w-full h-auto"
                    priority
                  />
                </div>
              </div>
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 animate-bounce">
            <ChevronDown className="h-6 w-6 text-[#62664B]/60" />
          </div>
        </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-white/20 mt-6 pt-4 text-center">
            <p className="text-white/80 text-sm sm:text-base">
              &copy; 2024 You-Care. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
